...
<div class="kicker">The composable skill library</div>

# Skills, a capability map

<div class="lede">The same library, mapped on two axes: <strong>where it sits in the workflow</strong> (understand → produce) and <strong>who it serves</strong> (risk / CCO vs relationship / RM). Guards wrap the top; eval measures the bottom.</div>

<div class="skillmap">

  <div class="band guards"><span class="bl">Foundation guards<br/><i>wraps every output</i></span><div class="chips"><span>grounding-claims-to-source</span><span>assessing-output-reliability</span><span>redacting-restricted-fields</span><span>screening-and-gating-output</span></div></div>

  <div class="plane risk">
    <span class="rl">Risk &amp; compliance<br/><i>CCO-facing</i></span>
    <div class="cell"><span>checking-covenant-compliance</span><span>detecting-deterioration-signals</span><span>measuring-engagement-coverage</span><span>assembling-watchlist-triage</span></div>
    <div class="cell"><span>reviewing-covenant-package</span></div>
    <div class="cell"></div>
  </div>

  <div class="plane rel">
    <span class="rl">Relationship &amp; growth<br/><i>RM-facing</i></span>
    <div class="cell"><span>building-client-360</span><span>flagging-renewal-and-retention</span></div>
    <div class="cell"><span>detecting-cross-source-discrepancies</span><span>verifying-commitment-fulfillment</span></div>
    <div class="cell"><span>drafting-rm-communications</span><span>drafting-relationship-review-memos</span><span>updating-the-crm</span></div>
  </div>

  <div class="band eval"><span class="bl">Eval &amp; governance<br/><i>measures everything</i></span><div class="chips"><span>running-the-eval-suite</span><span>viewing-eval-results</span><span>viewing-proposed-improvements</span></div></div>

  <div class="xaxis"><span class="sp"></span><span class="xstage">Sense &amp; detect</span><span class="xstage">Reconcile &amp; verify</span><span class="xstage">Draft &amp; act</span></div>
  <div class="xcap">Understand the data&nbsp;&nbsp;→→→&nbsp;&nbsp;produce output / action</div>

</div>

<!--
NOTES (~24s): "Same system, now the skill inventory mapped. Two axes: left to right is the workflow, understanding the data through to producing output; top to bottom is who it serves, risk and the CCO up top, the relationship and the RM below. The gold band, the compliance guards, wraps every output; the purple band, eval, measures everything. Track A lives in risk-and-detect; Track B in relationship, reconcile, and draft. The empty top-right is honest: risk skills inform, they do not draft; the RM acts."
-->
---
...
| *all five* | n/a | **§1 / §2 / §5**: confidential data on a personal ChatGPT |
...
<!-- _class: appendix gloss -->

<div class="kicker">Appendix · reference</div>

# What each skill achieves

<div class="cols">
<h4>Foundation / trust (cross-cutting)</h4>
<div class="g"><b>grounding-claims-to-source</b> · cite every claim to its source; uncitable → UNVERIFIED.</div>
<div class="g"><b>assessing-output-reliability</b> · qualitative reliability footer (Grounded / Partial), never a %.</div>
<div class="g"><b>redacting-restricted-fields</b> · §2.1 inputs (rating / watchlist / guarantor) never reach the model.</div>
<div class="g"><b>screening-and-gating-output</b> · block §4.2 credit language; tag §4.3 review.</div>
<h4>Risk & early-warning (Track A)</h4>
<div class="g"><b>checking-covenant-compliance</b> · latest-month DSCR/leverage vs thresholds, with cushion.</div>
<div class="g"><b>detecting-deterioration-signals</b> · full-history trends, status mislabel, thin cushion, lifecycle.</div>
<div class="g"><b>measuring-engagement-coverage</b> · days since the last substantive two-way contact.</div>
<div class="g"><b>assembling-watchlist-triage</b> · rank the book by risk × neglect (a facts order, not a rating).</div>
<h4>Relationship & reconciliation (Track B)</h4>
<div class="g"><b>flagging-renewal-and-retention</b> · healthy borrower at attrition risk; "engage," never a rate.</div>
<div class="g"><b>detecting-cross-source-discrepancies</b> · mis-dated entries, email-only decisions, contradictions.</div>
<div class="g"><b>verifying-commitment-fulfillment</b> · commitments met / unmet / open / unverifiable.</div>
<h4>Document intelligence (Track B)</h4>
<div class="g"><b>reviewing-covenant-package</b> · classify, refuse restricted, extract, recompute, completeness.</div>
<h4>Context & synthesis</h4>
<div class="g"><b>building-client-360</b> · consolidated dossier; flags the dimensions not covered.</div>
<h4>Drafting / output</h4>
<div class="g"><b>drafting-rm-communications</b> · factual client message; no commitments / credit bad-news.</div>
<div class="g"><b>drafting-relationship-review-memos</b> · assemble facts, RM writes the assessment (§4.2 pause).</div>
<h4>CRM enrichment</h4>
<div class="g"><b>updating-the-crm</b> · structured note + tasks, propose-only; RM approves the write.</div>
<h4>Eval & governance</h4>
<div class="g"><b>running-the-eval-suite</b> · run the golden set on live tools; refresh the scorecard.</div>
<div class="g"><b>viewing-eval-results</b> · display the latest scorecard / agent-eval (read-only).</div>
<div class="g"><b>viewing-proposed-improvements</b> · display the loop's advisory proposals (read-only).</div>
</div>

<!--
NOTES: Appendix glossary, one line per skill: what it achieves. Grouped by the same eight clusters as the previous slide.
-->
...
# The centerline MCP server + its tools

<div class="srvband">A local Python <strong>MCP server</strong> exposing the bank's data and the deterministic analysis / compliance logic as callable tools, the project's <strong>cross-surface compliance chokepoint</strong>: every retrieval strips restricted inputs (§2.1), halts prohibited borrowers (§5), and refuses guarantor documents; every artifact can route through the §4.2 output screen, <strong>in code, not a prompt</strong>. Runs host-side via <code>uv</code>, loaded by Claude Code (<code>.mcp.json</code>) and bridged into Claude Cowork (<code>claude_desktop_config.json</code>, type: sdk).</div>

<div class="toolgrid">
  <div class="toolcard"><div class="ct">Retrieval <span>(§2.1 / §5 enforced)</span></div>
    <div class="t"><b>get_borrower_dossier</b> profile + latest performance</div>
    <div class="t"><b>get_loan_performance</b> monthly DSCR / leverage / revolver</div>
    <div class="t"><b>get_activity_log</b> the CRM contact log</div>
    <div class="t"><b>get_emails</b> the email thread</div>
    <div class="t"><b>get_relationship_timeline</b> log + emails, one timeline</div>
    <div class="t"><b>list_documents</b> enumerate a package, host-side</div>
  </div>
  <div class="toolcard"><div class="ct">Track-A analysis <span>(deterministic)</span></div>
    <div class="t"><b>check_covenant_compliance</b> snapshot vs thresholds + cushion</div>
    <div class="t"><b>detect_deterioration_signals</b> trend, mislabel, lifecycle</div>
    <div class="t"><b>measure_engagement_coverage</b> substantive-contact gap</div>
    <div class="t"><b>assemble_watchlist</b> rank by risk × neglect</div>
    <div class="t"><b>flag_renewal_and_retention</b> inverse radar; never a rate</div>
  </div>
  <div class="toolcard"><div class="ct">Document intelligence</div>
    <div class="t"><b>classify_document</b> type a PDF; §2.1 pre-screen</div>
    <div class="t"><b>extract_document_fields</b> per-type schema extraction</div>
    <div class="t"><b>cross_validate_covenant</b> certified vs recomputed vs bank</div>
    <div class="t"><b>review_package</b> completeness + quality flags</div>
  </div>
  <div class="toolcard"><div class="ct">Compliance & output</div>
    <div class="t"><b>screen_and_finalize</b> §4.2 scan + reliability footer + §4.3 tag</div>
    <div class="t"><b>render_pdf</b> credit-file-grade PDF, letterhead</div>
  </div>
  <div class="toolcard"><div class="ct">Eval & governance</div>
    <div class="t"><b>run_evals</b> golden set on live tools; refresh scorecard</div>
    <div class="t"><b>get_latest_report</b> pull + show eval / improve / observability</div>
  </div>
</div>

<!--
NOTES: Appendix, the MCP layer. Server = the cross-surface chokepoint (guards in code, both surfaces). 19 tools in five buckets; retrieval enforces §2.1/§5, analysis is deterministic, output routes through screen_and_finalize.
-->
