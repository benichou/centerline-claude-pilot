...
**13 · A1, watchlist (~28s)**: "First prompt, 'who needs attention this week?' Watch Claude pick the
...
**14 · A2, covenant compliance (~22s)**: "Meridian, cushion and trend. DSCR 1.03 against a 1.20 floor, a
...
**15 · A3 ★, engagement coverage (~28s)**: "Our Deliverable-A find, 'who have I gone quiet on?' Days since substantive
...
**16 · Track B intro (~22s)**: "Track B is what I found in the data. The brief warns the obvious picks,
...
**17 · B1, retention (~24s)**: "B1 inverts the watchlist. Crestwood, pristine metrics, so it never shows
...
**18 · B2 ★, document intelligence (~32s)**: "The doc-intel centerpiece, Sarah's, and trust is everything
...
**19 · B3 ★, reconciliation (~30s)**: "B3 is Deliverable B's creative find, on real data, reconciling email, CRM,
...
**20 · B4, annual memo (~28s)**: "The skeptic's wedge, Marcus, 71 memos a year. The compliant rebuild of
...
**21 · How the CCO can trust it (~30s)**: "The CCO can't approve what she can't measure. Four layers. Layer
...
**22 · Governance, live (~24s)**: "The trust story, concrete, two prompts, live. 'Show me the latest agent
...
**23 · Honest 80/20 (~26s)**: "Honest eval. Works: grounded, cited, compliant by construction, deterministic
...
**24 · Adoption (~24s)**: "Adoption is the real risk, the CCO's own goal three, and no single tool wins
...
**25 · Production & rollout (~26s)**: "From pilot to production. Cowork is the RM surface, one plugin, no UI
...
**26 · Close (~18s)**: "The whole story in three words. Built, I ran it live. Trustworthy, compliant by
...
**Appendix (reference, pull up on demand, not in the ~45 min):**

**27 · Appendix · what each skill achieves**: one line per skill, grouped by the eight clusters from the map (slide 11). Pull up for "what skills did you build, and what does each do?"

**28 · Appendix · the centerline MCP server + tools**: the server is the cross-surface compliance chokepoint (guards in code, both surfaces); 19 tools in five buckets, retrieval enforces §2.1/§5, the analysis is deterministic, output routes through screen_and_finalize. Pull up for "what does the MCP layer do?"
